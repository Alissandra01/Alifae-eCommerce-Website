...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-9m3ur27298726_api1.business.example.com";
    private string APIPassword = "CLW9AQUG3ZFLQLKR";
    private string APISignature = "Am82Np6AEAAE8c8ZFN8ZSYXcXhsZAuwntGhpKu7OY31s46frO4ptVYNw";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (Alifae.Logic.ShoppingCartActions myCartOrders = new Alifae.Logic.ShoppingCartActions())
        {
